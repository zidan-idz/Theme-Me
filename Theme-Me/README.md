...
[![Version](https://img.shields.io/badge/Version-3.1%20(Yuzuki)-%23FF0000?style=for-the-badge)](https://github.com/zidan-idz/Theme-Me/releases)
...
*   🛡️ **Enhanced Safety** - Automatic backups of shell config and clean installation
...
# Install Git, Python, and Termux Tools
pkg install git python termux-tools -y
...
**Recommendations:**
- Backup your Termux configuration automatically created as `bash.bashrc.bak`
